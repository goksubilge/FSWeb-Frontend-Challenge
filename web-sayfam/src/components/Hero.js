      ...
      <div className=" flex justify-between items-center gap-4 max-[1024px]:flex-col-reverse ">
        <article className="mt-10 my-3">
          ...
          <div className="flex py-2 max-sm:flex-col max-sm:items-center gap-4">
            <a href="mailto:goksu.blge@gmail.com">
              <button className=" duration-500 text-[#7B61FF] text-lg font-medium w-36 max-sm:w-full h-12 border-2 border-[#7B61FF] hover:bg-[#7B61FF] hover:text-[#FFFFFF] bg-[#FFFFFF] rounded-md dark:bg-[#383838] dark:text-[#E1E1FF] dark:border-[#E1E1FF] dark:hover:bg-[#E1E1FF] dark:hover:text-[#000000] px-9">
                {hero.hire}
              </button>
            </a>
            <a href="https://github.com/goksubilge" target="_newtab">
            ...
            <a href="https://www.linkedin.com/in/bilge-goksu/" target="_newtab">
